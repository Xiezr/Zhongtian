...
(function () {
   ...
   *   ① 官府：右侧第 2 列起 2×2（**与玩家城 `makeCity` 的落位规则完全一致**，
   *      这样攻占后玩家看到的还是自己熟悉的格局）；
   *   ② 军营 **2 座**，紧挨官府（第一优先占位）；
  ...
  DATA.CITY_PLAN = {
    ...
    order: ['junying', 'junying', 'shuyuan', 'xiaochang', 'shichang', 'cangku', 'kezhan',
   ...
   * ============================================================ */
  DATA.TROOPS = {
    minfu:   { id: 'minfu', name: '民夫', icon: '🪓', hp: 100,  atk: 5,   def: 10, range: 10,   spd: 180,  gather: 2, load: 200,  food: 2,   pop: 1, time: 40,   cost: { grain: 50, wood: 150, iron: 10 }, unlock: { junying: 1 }, desc: '基础民夫，战力孱弱，可运输' },
    yibing:  { id: 'yibing', name: '义兵', icon: '🗡️', hp: 200, atk: 50,  def: 50, range: 20,  spd: 200,  gather: 3, load: 20,   food: 3,   pop: 1, time: 20,   cost: { grain: 80, wood: 100, iron: 50 }, unlock: { junying: 1 }, desc: '聚集的义军，初具战力' },
    chihou:  { id: 'chihou', name: '斥候', icon: '🦅', hp: 100,  atk: 20,  def: 20, range: 20,  spd: 3000, gather: 1, load: 6,    food: 5,   pop: 1, nocombat: true, time: 90,   cost: { grain: 120, wood: 200, iron: 150 }, unlock: { junying: 2, shuyuan: 2 }, desc: '极限速度，侦察/截援必备' },
    changqiang: { id: 'changqiang', name: '长枪兵', icon: '🔱', hp: 300, atk: 150, def: 150, range: 50, spd: 300, gather: 4, load: 40, food: 6, pop: 1, time: 140, cost: { grain: 150, wood: 500, iron: 100 }, unlock: { junying: 2, shuyuan: 2 }, desc: '克制骑兵，阵型严整' },
    daodun:  { id: 'daodun', name: '刀盾兵', icon: '🛡️', hp: 400, atk: 130, def: 250, range: 30, spd: 275, gather: 4, load: 30, food: 7, pop: 1, time: 210, cost: { grain: 200, wood: 150, iron: 400 }, unlock: { junying: 3, shuyuan: 3 }, desc: '高防御，克远程，炮灰首选' },
    gongjian: { id: 'gongjian', name: '弓箭手', icon: '🏹', hp: 320, atk: 220, def: 50, range: 1200, spd: 250, gather: 5, load: 25, food: 9, pop: 2, time: 340, cost: { grain: 300, wood: 350, iron: 300 }, unlock: { junying: 4, shuyuan: 4 }, desc: '远程主力，射程1200' },
    qingji:  { id: 'qingji', name: '轻骑兵', icon: '🐎', hp: 620, atk: 340, def: 180, range: 80, spd: 1000, gather: 6, load: 100, food: 18, pop: 2, time: 480, cost: { grain: 1000, wood: 600, iron: 500 }, unlock: { junying: 5, majiu: 1 }, desc: '机动突袭，抓将主力（需马厩）' },
    tieji:   { id: 'tieji', name: '铁骑兵', icon: '🐴', hp: 1200, atk: 520, def: 350, range: 70, spd: 600, gather: 9, load: 80, food: 35, pop: 3, time: 1450, cost: { grain: 2000, wood: 500, iron: 2500 }, unlock: { junying: 7, shuyuan: 6, majiu: 3 }, desc: '重装铁骑，攻守兼备（需马厩3）' },
    zhouche: { id: 'zhouche', name: '辎重车', icon: '🛺', hp: 700, atk: 10, def: 60, range: 10, spd: 150, gather: 1, load: 5000, food: 10, pop: 4, time: 970, cost: { grain: 600, wood: 1500, iron: 350 }, unlock: { junying: 5 }, desc: '负重5000，专属运资' },
    ...
    /* 特殊兵种（需对应州城 + 科技） */
    qingzhoubing: { id: 'qingzhoubing', name: '青州兵', icon: '🥷', hp: 620, atk: 350, def: 200, range: 60, spd: 350, gather: 6, load: 50, food: 10, pop: 2, time: 115, cost: { grain: 800, wood: 600, iron: 400 }, unlock: { junying: 8, shuyuan: 6, city: 'qingzhou', tech: { xingjun: 5 } }, desc: '青州精兵' },
    tengjiabing: { id: 'tengjiabing', name: '藤甲兵', icon: '🛡️', hp: 600, atk: 340, def: 350, range: 60, spd: 300, gather: 5, load: 35, food: 10, pop: 2, time: 170, cost: { grain: 600, wood: 300, iron: 500 }, unlock: { junying: 8, shuyuan: 7, city: 'yizhou', tech: { fanghu: 8 } }, desc: '防350，刀枪不入（惧火）' },
    tuqibing: { id: 'tuqibing', name: '突骑兵', icon: '🏇', hp: 640, atk: 330, def: 150, range: 1000, spd: 450, gather: 7, load: 45, food: 15, pop: 2, time: 270, cost: { grain: 1200, wood: 500, iron: 800 }, unlock: { junying: 9, shuyuan: 7, majiu: 3, city: 'hebei', tech: { paoshe: 5, jiayu: 5 } }, desc: '骑射突袭，射程1000' },
    hubaoqi: { id: 'hubaoqi', name: '虎豹骑', icon: '🐯', hp: 800, atk: 510, def: 250, range: 70, spd: 850, gather: 10, load: 60, food: 50, pop: 3, time: 385, cost: { grain: 1500, wood: 800, iron: 1200 }, unlock: { junying: 9, shuyuan: 8, majiu: 4, city: 'sili', tech: { tongshuai: 9, lianbing: 7 } }, desc: '曹魏精锐骑兵' },
    xiliangtieqi: { id: 'xiliangtieqi', name: '西凉铁骑', icon: '🐻', hp: 1400, atk: 700, def: 400, range: 80, spd: 750, gather: 10, load: 100, food: 50, pop: 4, time: 1160, cost: { grain: 1800, wood: 700, iron: 2000 }, unlock: { junying: 9, shuyuan: 8, majiu: 4, city: 'liangzhou', tech: { jiayu: 7 } }, desc: '攻450防400，攻守兼备' },
    nanjiangxiangbing: { id: 'nanjiangxiangbing', name: '南疆象兵', icon: '🐘', hp: 3000, atk: 880, def: 400, range: 70, spd: 400, gather: 12, load: 60, food: 50, pop: 5, time: 3500, cost: { grain: 3000, wood: 1000, iron: 2500 }, unlock: { junying: 9, shuyuan: 8, city: 'yizhou', tech: { yiliao: 8, zhandou: 7 } }, desc: '血2500，战场重坦' },
  };
