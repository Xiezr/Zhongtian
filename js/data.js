...
(function () {
  ...
  DATA.SCENE_FLOW = {
    /* ---------- 通用六活动 ---------- */
    tao: { art: '🏕️', escLabel: '🏃 鸣金收兵', backLabel: '收兵回城',
      stages: [
    ...
    qie: { art: '🎋', escLabel: '🤝 拱手告辞', backLabel: '抱拳作别',
      stages: [
    ...
    shi: { art: '🌀', escLabel: '🚪 退阵下山', backLabel: '下山回城',
      stages: [
    ...
    cai: { art: '🌸', escLabel: '🚶 放下药篓', backLabel: '提着药篓回城',
      stages: [
    ...
    xiu: { art: '☁️', escLabel: '🌙 提前收功', backLabel: '起身回城',
      stages: [
    ...
    bai: { art: '🍵', escLabel: '🚪 改日再来', backLabel: '谢过主人',
      stages: [
    ...
    /* ---------- 六地形招牌 ---------- */
    hill_scene: { art: '🚩', escLabel: '🍃 悄然下山', backLabel: '告辞下山',
      stages: [
    ...
    lake_scene: { art: '🌊', escLabel: '🧺 收起鱼竿', backLabel: '收竿回城',
      stages: [
    ...
    zhaoze_scene: { art: '🌫️', escLabel: '🏃 退出沼泽', backLabel: '退回高地',
      stages: [
    ...
    desert_scene: { art: '🔥', escLabel: '🏛️ 退出地宫', backLabel: '出宫回城',
      stages: [
    ...
    forest_scene: { art: '🌲', escLabel: '🌲 就此收弓', backLabel: '收弓回程',
      stages: [
    ...
    caoyuan_scene: { art: '🌤️', escLabel: '🐎 勒马回城', backLabel: '策马归营',
      stages: [
